                        ...
                        if !chunks.is_empty() {
                            ...
                            if pipe_parts.len() == 2 {
                                ...
                                if size_type_split.len() == 2 {
                                    ...
                                    if chunks.len() >= 3 {
                                        let minmax_str =
                                            chunks[2].trim_matches(|c| c == '[' || c == ']');
                                        let minmax_parts: Vec<&str> =
                                            minmax_str.split('|').collect();
