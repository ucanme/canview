...
pub fn serialize_file_statistics(stats: &FileStatistics) -> Vec<u8> {
    ...
    writer.write_u32::<LittleEndian>(0x47474F4C).unwrap(); // Signature "LOGG" (little-endian: 4C 4F 47 47)
    writer
...
fn main() {
    ...
    for i in 0..10 {
        ...
        let header = ObjectHeader {
            base: blf::objects::object_header::ObjectHeaderBase {
    ...
    let container_header = ObjectHeader {
        base: blf::objects::object_header::ObjectHeaderBase {
            ...
            header_size: 32,
            header_version: 1,
            object_size: final_container_size,
    ...
    final_stats.object_count = object_count as u32; // Count of internal objects? Or count of container?
    ...
    file.write_all(&container_bytes)
