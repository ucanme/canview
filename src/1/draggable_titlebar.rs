use gpui::{
    ...
    SharedString, Size, Window, WindowBackgroundAppearance, WindowBounds, WindowControlArea,
...
// TitleBarState removed — using direct on_mouse_down to start native move
...
impl Render for WindowContent {
    fn render(&mut self, window: &mut Window, _: &mut Context<Self>) -> impl IntoElement {
        ...
        div()
            ...
            // Title bar: mark as drag area and start native window move on left mouse down
            .child(
                div()
                    .w_full()
                    .h(px(28.))
...
fn build_window_options(display_id: DisplayId, bounds: Bounds<Pixels>) -> WindowOptions {
    WindowOptions {
        ...
        // Allow moving the window (required for native move to function)
        is_movable: true,
        app_id: None,
